...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Welcome to the My Console Bank");
        ...
        while(running){
            ...
            System.out.println("You choose: " + inputChoice);
    ...
    private static void listAccounts(Scanner scanner, BankService bankService) {
        bankService.listAccounts().forEach(a -> System.out.println(a.getAccountNumber() + " | " + a.getAccountType() + " | " + a.getBalance()));
    }
